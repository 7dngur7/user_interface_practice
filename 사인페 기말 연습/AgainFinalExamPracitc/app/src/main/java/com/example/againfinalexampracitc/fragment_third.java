...
import com.example.againfinalexampracitc.databinding.FragmentThirdBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding.thirdButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                bundle.putString("fromthird", "fromthird111");
                fragment_third_two fragmentThirdTwo = new fragment_third_two();

                fragmentThirdTwo.setArguments(bundle);
                getActivity().getSupportFragmentManager().beginTransaction()
                        .add(R.id.thirdChild, fragmentThirdTwo)
                        .addToBackStack(null)
                        .commit();
        ...
        getParentFragmentManager().setFragmentResultListener("bundle3", this, new FragmentResultListener() {
            @Override
            public void onFragmentResult(@NonNull String requestKey, @NonNull Bundle result) {
                binding.thirdSecond.setText(result.getString("key3"));
            }
        });
