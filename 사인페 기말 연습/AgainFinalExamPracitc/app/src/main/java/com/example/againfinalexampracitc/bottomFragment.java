...
import com.example.againfinalexampracitc.databinding.FragmentBottomSheetBinding;
...
public class bottomFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        FragmentBottomSheetBinding binding = FragmentBottomSheetBinding.inflate(inflater, container, false);
        binding.onButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                binding.bottomText.setText("ok");
        ...
        binding.okButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                String answer = binding.bottomText.getText().toString();
                Bundle bundle = new Bundle();
                bundle.putString("bottom", answer);
